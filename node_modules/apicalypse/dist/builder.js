...
class Builder {
  ...
  exclude(exclude) {
    if (exclude) {
      let excludeString = exclude && exclude.constructor === Array ? exclude.join(",") : exclude;
  ...
  build() {
    ...
    this.apicalypse = Object.keys(this.queryFields).length > 1 || this.queryFields.where.length > 1 ? Object.values(rest).concat(where).join(";") + ";" : "";
    return this;
  }
