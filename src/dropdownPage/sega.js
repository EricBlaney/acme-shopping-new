...
class topSegaGenesisGames extends Component {
    ...
    render() {
        const {  topSegaGenesisGames, auth } = this.props;
...
const mapStateToProps = ({ product, cart })=> {
  ...
  export default connect(mapStateToProps,mapDispatch)(topSegaGenesisGames)
