...
class thisYearsGames1989 extends Component {
    ...
    render() {
        const {  thisYearsGames1989, auth } = this.props;

    return (
    <div>
        <main>
        <h2>Top 1989 Games</h2>
...
const mapStateToProps = ({ product, cart, auth })=> {
  ...
  export default connect(mapStateToProps,mapDispatch)(thisYearsGames1989)
