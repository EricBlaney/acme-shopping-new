...
class thisYearsGames1987 extends Component {
    ...
    render() {
        const {  thisYearsGames1987, auth } = this.props;

    return (
    <div>
        <main>
        <h2  class='h2'>Top 1987 Games</h2>
...
const mapStateToProps = ({ auth, product, cart })=> {
  ...
  export default connect(mapStateToProps,mapDispatch)(thisYearsGames1987)
