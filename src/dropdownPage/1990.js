...
class thisYearsGames1990 extends Component {
    ...
    render() {
        const {  thisYearsGames1990, auth } = this.props;

    return (
    <div>
        <main>
        <h2  class='h2'>Top 1990 Games</h2>
...
const mapStateToProps = ({ product, cart, auth })=> {
  ...
  export default connect(mapStateToProps,mapDispatch)(thisYearsGames1990)
